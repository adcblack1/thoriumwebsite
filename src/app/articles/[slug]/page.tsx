            ...
            <article className="max-w-[780px] mx-auto px-6 py-10 bg-white">
              ...
              prose-blockquote:border-l-[#5170ff] prose-blockquote:text-[#1b1b1b]/80"
                        html={(article.content || '<p>Content not available.</p>')
                                ...
                                .replace(/<h[23]>Into the Valley<\/h[23]>/gi, '<div style="text-align:center;margin:2em 0 1em;"><img src="/IN THE VALLEY NEWS.png" alt="Into the Valley" style="display:inline-block;width:100%;height:auto;" /></div>')
                                .replace(/<p>---<\/p>/g, '')
                                .replace(/<hr\s*\/?>/g, '')}
                    />
                </FadeIn>
